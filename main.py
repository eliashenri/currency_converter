...
class CurrencyConverter():
    ...
    def convert(self, from_currency, to_currency, amount):
        ...
        if from_currency != 'BRL':
            ...
            #limitando a precisão em 4 casas decimais
...
class App(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        # Label
        self.intro_label = Label(self, text='Conversor de Moeda', fg='black', relief=tk.RAISED, borderwidth=3)
        self.intro_label.config(font=('Courier', 15, 'bold'))

        self.date_label = Label(self,
                                text=f"1 Dolar é igual = {self.currency_converter.convert('USD', 'BRL', 1)} BRL \n Data : {self.currency_converter.data['date']}",
                                relief=tk.GROOVE, borderwidth=5)

        self.intro_label.place(x=127, y=5)
        ...
        self.to_currency_variable.set("BRL")  # default value
